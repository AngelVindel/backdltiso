      ...
      sections: [
        ...
        },
        {
          ...
          children: [
            ...
            ...this.createSection(
              '6. Principios de la Política de Seguridad de la Información',
              [
            ...
            ...this.createSection(
              '7.1. Formación y concientización',
              [
            ...
            ...this.createSection(
              '8.1. Gestión de dispositivos BYOD o dispositivos personales',
              [
            ...
            ...this.createSection(
              '8.2. Gestión del ciclo de vida de la información',
              [
            ...
            ...this.createSection(
              '9.3. Gestión de información privilegiada',
              [
            ...
            ...this.createSection(
              '9.4. Etiquetado de la información',
              [
            ...
            ...this.createSection(
              '9.5. Manipulación de la información',
              [
            ...
            ...this.createSection(
              '9.6. Privacidad de la información',
              [
            ...
            ...this.createSection(
              '11.4. Trabajo remoto / Teletrabajo',
              [
            ...
            ...this.createSection(
              '12. Gestión del ciclo de vida de la identidad',
              [
            ...
            ...this.createSection(
              '12.1. Identidades privilegiadas',
              [
            ...
            ...this.createSection(
              '14. Seguridad en la nube o cloud',
              [
            ...
            ...this.createSection(
              '21. Cumplimiento regulatorio de sistemas',
              [
