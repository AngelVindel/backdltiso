      ...
      if (typeof item === 'string') {
        const parts = item.split(/(-.*?-)/).map((part) => {
          if (part.startsWith('-') && part.endsWith('-')) {
            ...
            return new TextRun({
              text: part.replace(/NOMBRE_EMPRESA/g, nombreEmpresa),
            });
          }
        });
    ...
    return new Table({
      rows: [
        ...
        ...[
          {
            sub: '4.1',
            desc: 'Contexto organizacional',
            text: 'Determinar los objetivos del SGSI de la organización y cualquier cuestión que pueda comprometer su efectividad',
          },
          {
            sub: '4.2',
            desc: 'Partes interesadas',
            text: 'Identificar las partes interesadas incluyendo leyes aplicables, regulaciones, contratos, etc.',
          },
          {
            sub: '4.3',
            desc: 'Alcance del SGSI',
            text: 'Determinar y documentar el alcance del SGSI',
          },
          {
            sub: '4.4',
            desc: 'SGSI',
            text: 'Establecer, implementar, mantener y mejorar continuamente un SGSI de conformidad con la norma',
          },
        ]
          .map((sub) => [
            new TableRow({
        ...
        ...[
          {
            sub: '5.1',
            desc: 'Liderazgo y compromiso',
            text: 'La alta dirección debe demostrar liderazgo y compromiso en relación con el SGSI',
          },
          {
            sub: '5.2',
            desc: 'Política',
            text: 'Establecer la política de seguridad de la información',
          },
          {
            sub: '5.3',
            desc: 'Roles, responsabilidades y autoridades en la organización',
            text: 'Asegurar que los roles y responsabilidades de seguridad de la información son definidos y comunicados',
          },
        ]
          .map((sub) => [
            new TableRow({
            ...
            new TableCell({
              children: [
                new Paragraph({
                  alignment: AlignmentType.LEFT,
                  children: [
                    new TextRun({ text: 'Planificación', bold: true }),
                  ],
                }),
              ],
              shading: { fill: 'B7DEE8', type: ShadingType.CLEAR },
        ...
        ...[
          {
            sub: '6.1',
            desc: 'Acciones para abordar los riesgos y oportunidades',
            text: 'Acciones para abordar los riesgos y oportunidades.',
          },
          {
            sub: '6.2',
            desc: 'Objetivos de seguridad de la información y planificación para lograrlos',
            text: 'Establecer y documentar los objetivos y planes de seguridad de la información.',
          },
          {
            sub: '6.3',
            desc: 'Planificación de cambios',
            text: 'Todos los cambios al SGSI son llevados a cabo de manera planificada...',
          },
        ]
          .map((sub) => [
            new TableRow({
        ...
        ...[
          {
            sub: '7.1',
            desc: 'Recursos',
            text: 'Determinar y proporcionar los recursos necesarios para el SGSI.',
          },
          {
            sub: '7.2',
            desc: 'Competencias',
            text: 'Determinar, documentar y poner a disposición las competencias necesarias.',
          },
          {
            sub: '7.3',
            desc: 'Concientización',
            text: 'Establecer un programa de concientización en seguridad.',
          },
          {
            sub: '7.4',
            desc: 'Comunicación',
            text: 'Determinar la necesidad para las comunicaciones internas y externas relevantes al SGSI.',
          },
          {
            sub: '7.5',
            desc: 'Información documentada',
            text: 'Proveer la documentación requerida por la norma así como lo requerido por la organización.',
          },
        ]
          .map((sub) => [
            new TableRow({
        ...
        ...[
          {
            sub: '8.1',
            desc: 'Planificación y control operacional',
            text: 'Planificar, implementar, controlar y documentar el proceso del SGSI para gestionar los riesgos.',
          },
          {
            sub: '8.2',
            desc: 'Apreciación del riesgo de seguridad de la información',
            text: 'Realizar y documentar los riesgos de seguridad de la información en forma regular y ante cambios significativos.',
          },
          {
            sub: '8.3',
            desc: 'Tratamiento del riesgo de seguridad de la información',
            text: 'Implementar el plan de tratamiento de riesgos y documentar los resultados.',
          },
        ]
          .map((sub) => [
            new TableRow({
        ...
        ...[
          {
            sub: '9.1',
            desc: 'Seguimiento, medición, análisis y evaluación',
            text: 'Hacer seguimiento, medir, analizar y evaluar el SGSI y los controles.',
          },
          {
            sub: '9.2',
            desc: 'Auditoría interna',
            text: 'Planificar y llevar a cabo auditorías internas del SGSI.',
          },
          {
            sub: '9.3',
            desc: 'Revisión por la dirección',
            text: 'Realizar revisiones por la dirección del SGSI regularmente.',
          },
        ]
          .map((sub) => [
            new TableRow({
        ...
        ...[
          {
            ...
            text: 'Mejorar continuamente el SGSI.',
          },
          {
            sub: '10.2',
            desc: 'No conformidad y acciones correctivas',
            text: 'Identificar, corregir y llevar a cabo acciones para prevenir la recurrencia de no conformidades, documentar las acciones.',
          },
        ]
          .map((sub) => [
            new TableRow({
            ...
            new TableCell({
              children: [
                new Paragraph({
                  ...
                  children: [
                    new TextRun({
                      text: 'Identificar, corregir y llevar a cabo acciones para prevenir la recurrencia de no conformidades, documentando las acciones',
                    }),
                  ],
                }),
              ],
        ...
        new TableRow({
          children: [
            ...
            new TableCell({
              children: [
                new Paragraph(
                  'Key performance indicator. En español: indicador clave de rendimiento',
                ),
              ],
              width: { size: 80, type: WidthType.PERCENTAGE },
            }),
